...
const addPlayerToTrade = (player) => {
  ...
  const isPick = player.player_full_name.match(/\b(2026|2027)\b/)
...
const isPick = (player) => {
  return player.player_full_name.match(/\b(2026|2027)\b/)
}
...
.layout {
  min-height: 100vh;
  background: var(--color-background-soft); /* Use theme variable */
}
